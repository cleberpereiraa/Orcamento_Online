...
$(function(){
    ...
    function atualizar_orcamento(parametros){
            ...
            let precoUnit = camisetas[parametros.cor][parametros.gola][parametros.estampa].preco_unit;
            let foto = "img/" + camisetas[parametros.cor][parametros.gola][parametros.estampa].foto;

            let valor_total = quantidade * precoUnit;
    ...
    function updateLocalStorage(parametros){
    ...
    $(".option-filter div").click(function(){
        ...
        updateLocalStorage(parametros_pesquisa);
    ...
    //verificar local storage e atualizar a varialvel parametros_pesquisa
